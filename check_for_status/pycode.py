...
@app.route('/get_xx', methods=['GET'])
def get_xx():
    global xx  # Declare xx as global
    return f"Current value of xx: {xx}"




#xx = 47500  # Initial value of xx
#
#@app.route('/update_xx', methods=['POST'])
#def update_xx():
#    global xx  # Declare xx as global
#    new_value = int(request.form.get('new_value'))  # Get the new value from the form data
#    xx = new_value  # Update the global variable xx
#    return f"Value of xx updated to: {xx}"
#
#@app.route('/get_xx', methods=['GET'])
#def get_xx():
#    global xx  # Declare xx as global
